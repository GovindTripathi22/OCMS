  ...
  return (
    <main className="min-h-screen relative overflow-hidden selection:bg-[var(--ocms-accent)] selection:text-white">
      ...
      <section className="relative z-10 w-full max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        <h1 className="group/list animate-slide-up opacity-0 [animation-delay:200ms] [animation-fill-mode:forwards] text-5xl md:text-8xl font-black tracking-tighter text-white leading-[0.9] mb-8 cursor-default flex flex-col items-start w-fit">
          <span className="transition-all duration-500 group-hover/list:blur-[8px] group-hover/list:opacity-20 hover:!blur-none hover:!opacity-100 hover:scale-[1.05] origin-left">From Web</span>
          <span className="text-[var(--ocms-accent)] transition-all duration-500 group-hover/list:blur-[8px] group-hover/list:opacity-20 hover:!blur-none hover:!opacity-100 hover:scale-[1.05] origin-left">to 3D.</span>
        </h1>
